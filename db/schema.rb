...
ActiveRecord::Schema.define(version: 20170323175643) do
  ...
  create_table "playlist_follows", force: :cascade do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["playlist_id", "user_id"], name: "index_playlist_follows_on_playlist_id_and_user_id", unique: true, using: :btree
